...
export default function DataSourcesPage() {
  ...
  const [showModal, setShowModal] = useState(null); // 'whatsapp' | 'instagram' | null
      ...
      <div className="px-6 py-4 border-b border-[var(--border)]">
        <div className="flex gap-3 flex-wrap">
          ...
          >
            ...
            <span className="font-medium text-green-400">Import WhatsApp</span>
          </button>
          ...
          >
            ...
            <span className="font-medium text-pink-400">Import Instagram</span>
          </button>
        </div>
      </div>
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center h-full text-center">
            ...
            <p className="text-muted text-sm max-w-md">
              Import your WhatsApp chats or Instagram data to help your Twin understand you better.
            </p>
          </div>
        ) : (
          ...
          <div className="glass rounded-2xl p-6 w-full max-w-md animate-fadeIn">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-lg font-bold">
                {showModal === 'whatsapp' ? 'Import WhatsApp Chat' : 'Import Instagram Data'}
              </h2>
            ...
            <form onSubmit={handleUpload} className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium mb-2">
                  {showModal === 'whatsapp' ? 'Your Name in Chat' : 'Your Instagram Username'}
                </label>
                <input
                  type="text"
                  value={ownerName}
                  onChange={(e) => setOwnerName(e.target.value)}
                  placeholder={showModal === 'whatsapp' ? 'e.g., Tezcan' : 'e.g., tezcan_'}
                ...
                <p className="text-xs text-muted mt-1">
                  {showModal === 'whatsapp' 
                    ? 'Enter your name as it appears in the chat export'
              ...
              <div>
                <label className="block text-sm font-medium mb-2">
                  {showModal === 'whatsapp' ? 'Chat Export File (.txt)' : 'Instagram Export File (.zip)'}
                </label>
                <input
                  ref={fileInputRef}
                  type="file"
                  accept={showModal === 'whatsapp' ? '.txt' : '.zip'}
                  ...
                  {selectedFile ? (
                    ...
                    <div>
                      ...
                      <p className="text-muted">
                        Click to select {showModal === 'whatsapp' ? '.txt' : '.zip'} file
                      </p>
                    </div>
                  )}
                </button>
